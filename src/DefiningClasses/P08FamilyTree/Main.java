...
public class Main {
    ...
    private static void addParent(Map<String, Person> personName, String parent, String child) {
        if (!child.contains("/")) {
    ...
    private static void addChild(Map<String, Person> personName, String parent, String child) {
        if (!parent.contains("/")) {
